...
public class UploadService extends IntentService {
    ...
    public static String sn,wish,help,note,type,name,content;
...
//        String chosenAccountName = intent.getStringExtra(MainActivity.ACCOUNT_KEY);
        ...
        wish=intent.getStringExtra("wish");
        ...
        //String email = sharedPreferences.getString(getString(R.string.MEMBER_EMAIL), "0");


        credential =
                GoogleAccountCredential.usingOAuth2(getApplicationContext(), Lists.newArrayList(SCOPES));
        credential.setSelectedAccountName(sharedPreferences.getString(getString(R.string.MEMBER_EMAIL), "0"));
