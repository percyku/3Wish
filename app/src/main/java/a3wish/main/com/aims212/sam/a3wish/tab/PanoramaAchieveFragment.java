...
public class PanoramaAchieveFragment extends Fragment implements
        OnMapReadyCallback,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mapFragment = (SupportMapFragment) fm.findFragmentById(R.id.panoramaAchieve_Fragment);
        if (mapFragment == null) {
            mapFragment = SupportMapFragment.newInstance();
            fm.beginTransaction().replace(R.id.panoramaAchieve_Fragment, mapFragment).commit();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            ...
            mView = inflater.inflate(R.layout.fragment_panorama_achieve, container, false);
    ...
    private void initialMarkerPosition() {
        ...
        if (mLastLocation != null) {
            ...
            for (int i = 0; i < ToolArray.needHelpeListArryV2.length; i++) {
                ...
                if (ToolArray.needHelpeListArryV2[i].getWish_Type().toString().equals("360°影片")) {
